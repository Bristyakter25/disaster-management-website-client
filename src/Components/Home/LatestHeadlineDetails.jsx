        ...
        <div className="p-8 space-y-6">
          ...
          {alert.donationNeeded && (
            <div className="mt-6 text-center">
              <a
                href={`/donate/${alert._id}`} // replace with your donation route
                className="inline-block bg-red-600 hover:bg-red-700 text-white font-semibold px-6 py-3 rounded-lg shadow-md transition-all duration-300"
              >
                Donate Now
              </a>
